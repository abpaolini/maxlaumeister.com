    ...
    <script>
        document.addEventListener("DOMContentLoaded", function(event) { 
            ...
            $.get( "http://api.maxlaumeister.com/stackexchange/helpful_answers/", function( response ) {
                answers = response.data.upvoted_or_accepted;
                if (rep !== -1) showStats();
            });
            ...
            function showStats() {
                $( "#so_answers" ).html('As of today, I\'ve written <a href="https://stackoverflow.com/users/2234742/maximillian-laumeister?tab=answers&sort=votes"><span id="so_answers">' + answers + '</span> answers on Stack Overflow</a> that other programmers have found helpful. This has earned me ' + rep + ' reputation on the site.');
            }
